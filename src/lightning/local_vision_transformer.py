...
class MLPBlock(MLP):
    ...
    def __init__(self, in_dim: int, mlp_dim: int, dropout: float,keep_nr_of_paramters_equal: bool):
        super().__init__(in_dim, [mlp_dim, in_dim], activation_layer=nn.GELU, inplace=None, dropout=dropout,keep_nr_of_paramters_equal=keep_nr_of_paramters_equal)
...
class EncoderBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = MLPBlock(hidden_dim, mlp_dim, dropout,keep_nr_of_paramters_equal)
    ...
    def __init__(
        ...
        for i in range(num_layers):
            layers[f"encoder_layer_{i}"] = EncoderBlock(
                ...
                attention_dropout,
                norm_layer,
                keep_nr_of_paramters_equal=keep_nr_of_paramters_equal
            )
...
def vit_b_32(*, weights = None, progress: bool = True,keep_nr_of_paramters_equal =False, **kwargs: Any) -> VisionTransformer:
    """
    Constructs a vit_b_32 architecture from
    `An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale <https://arxiv.org/abs/2010.11929>`_.
    Modified to use locally conected perceptrons in teh second layer of its MLPs
